...
declare namespace Cypress {
  interface Chainable {
     ...
     *
     * Works on its own but should be chained after cy.cs() or cy.get() if there
     * are multiple autocompletes in the DOM.
     */
    getDropdownOptions(): Chainable<Element>;

    /**
     * Visit given `url` and wait for XHR requests to complete before
     * proceeding.
     */
