...
export type SearchCharactersByMainQuery = { __typename?: 'Query', searchCharactersByMain: Array<{ __typename?: 'Character', name: string, esiId: string }> };

export type UserFieldsForManagerFragment = { __typename?: 'SanitizedUser', main: { __typename?: 'Character', esiId: string, name: string, portraitUrl: string, corporation: { __typename?: 'Corporation', esiId: string, name: string, ticker: string }, alliance?: { __typename?: 'Alliance', esiId: string, name: string, ticker: string } | null } };
